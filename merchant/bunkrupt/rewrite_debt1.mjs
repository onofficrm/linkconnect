...
const content = `import { PageHeaderWithImage, SummaryCards, SectionTitle, Checklist, NoticeBox, FAQAccordion, BottomCTA } from '../../components/InfoComponents';
...
`
fs.writeFileSync('src/pages/info-tabs/DebtCollectionTab1.tsx', content, 'utf8');
