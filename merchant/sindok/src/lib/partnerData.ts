...
const PAGE_ROOT_ID = 'sindok-merchant-page';
const DEFAULT_MERCHANT_ID = '';
const DEFAULT_CAMPAIGN_ID = 'CPA-00014';
const DEFAULT_MERCHANT_NAME = '신독환경';
...
export function getPartnerData(): PartnerData {
  ...
  return {
    ...
    merchant_id:
      ...
      DEFAULT_MERCHANT_ID,
    landing_id: getParam('landing_id') || injectedString('landing_id') || 'sindok',
    affiliate_id:
