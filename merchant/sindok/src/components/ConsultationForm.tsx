      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-10 space-y-3">
          ...
          <p className="text-slate-300 text-sm sm:text-base">
            간단한 상담 신청을 남겨주시면 <br className="sm:hidden" />
              ...
              <div className="pt-2 space-y-4 border-t border-slate-100">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 min-h-[48px] bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:border-blue-600 focus:outline-none transition-all font-medium"
                    >
                      <option value="주거공간 정리">주거공간 정리</option>
                      <option value="사무실 정리">사무실 정리</option>
                      <option value="가구 및 생활용품 처리">가구 및 생활용품 처리</option>
                      <option value="폐기물 정리">폐기물 정리</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="궁금하신 점이나 특이사항이 있다면 적어주세요."
