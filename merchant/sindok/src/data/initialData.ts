...
export const REVIEW_IMAGES: ReviewImageItem[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: "2026-07",
    content: "빠르고 친절하며 합리적인 가격. 사장님이 직접 연락·사진 확인까지 해 주셔서 몰라보게 깨끗해졌습니다.",
    tags: [],
  },
  {
    id: "review-image-05",
  ...
  },
  {
    ...
    rating: 5,
    date: "2026-07",
    content: "진솔한 상담으로 바로 예약. 숙련된 팀이 꼼꼼히 정리하고 사후 청소까지 깔끔, 1년 걱정이 한순간에 풀렸습니다.",
