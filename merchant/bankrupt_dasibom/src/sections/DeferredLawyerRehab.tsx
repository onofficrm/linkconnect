import { ArrowRight, BadgeCheck, Briefcase, CheckCircle2, FileText, Scale } from 'lucide-react';
...
const LAWYER_PROFILE = {
  ...
  strengths: [
    ...
    {
      title: '개인회생·개인파산의 현실적 해법',
      desc: '가능성만 이야기하지 않고, 현재 상황을 기준으로 실행 가능한 방향을 제시합니다.',
    },
  ],
};

type Props = {
  onScrollToForm: (type?: string) => void;
};

export default function DeferredLawyerRehab({ onScrollToForm }: Props) {
  return (
    <>
