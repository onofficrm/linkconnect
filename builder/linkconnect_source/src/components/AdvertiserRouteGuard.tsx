  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        {isPending ? (
          <>
            <h1 className="text-2xl font-bold text-slate-900 mb-3">광고주 등록 확인</h1>
            <p className="text-slate-600 mb-4">
              이전에 신청하신 내역이 있습니다. 아래 버튼을 누르면 즉시 활성화되어 광고주센터를 이용할 수 있습니다.
            </p>
            {auth.merchantCode && (
          ...
          <>
            ...
            <p className="text-slate-600 mb-6">
              광고주센터를 이용하려면 광고주로 등록해 주세요. 등록 즉시 이용할 수 있습니다.
            </p>
            {applyError && (
              <p className="text-sm text-red-600 mb-4">{applyError}</p>
            )}
