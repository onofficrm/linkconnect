            ...
            {images.map((img, index) => (
              ...
              >
                <div className="relative aspect-video bg-slate-100">
                  <img src={promoPreviewImageUrl(img.downloadUrl)} alt={img.imageTitle || img.originalFilename} className="w-full h-full object-contain" loading="lazy" decoding="async" />
                  {!disabled ? (
