...
export function PartnerLinks() {
  ...
  const copyUrl = async (url: string, id: number, successMsg = '링크가 복사되었습니다.') => {
    try {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 -mt-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            onClick={() =>
              links[0]
                ? openWidgetGuideForLink(links[0], 'install')
                : openWidgetGuide('', 'install')
            }
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2 shrink-0">
              ...
              <button
                type="button"
                onClick={() =>
                  links[0] ? openWidgetGuideForLink(links[0], 'preset') : openWidgetGuide('', 'preset')
                }
              ...
              <button
                type="button"
                onClick={() =>
                  links[0] ? openWidgetGuideForLink(links[0], 'convert') : openWidgetGuide('', 'convert')
                }
