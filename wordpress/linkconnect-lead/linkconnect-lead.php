<?php
/**
 * Plugin Name: LinkConnect 상담폼
 * Plugin URI:  https://linkconnect.co.kr/
 * Description: 파트너 홍보코드(lkCode)로 LinkConnect 상담신청 폼을 워드프레스에 삽입합니다.
 * Version:     1.0.0
 * Requires at least: 5.8
 * Requires PHP: 7.4
 * Author:      LinkConnect
 * Author URI:  https://linkconnect.co.kr/
...
define('LC_LEAD_DEFAULT_ORIGIN', 'https://linkconnect.co.kr');
