...
class LinkConnect_Lead_Settings
{
    ...
    {
        add_options_page(
            __('LinkConnect 상담폼', 'linkconnect-lead'),
            __('LinkConnect 상담폼', 'linkconnect-lead'),
            'manage_options',
            'linkconnect-lead',
    ...
    public static function render_page()
    {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html__('LinkConnect 상담폼', 'linkconnect-lead'); ?></h1>
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php echo esc_html__('기본값: https://linkconnect.co.kr (변경 불필요)', 'linkconnect-lead'); ?></p>
                        </td>
                    </tr>
                    <tr>
            ...
            <ol>
                ...
                <li><?php echo esc_html__('페이지/글 편집에서 숏코드 또는 「LinkConnect 상담폼」 블록을 넣습니다.', 'linkconnect-lead'); ?></li>
