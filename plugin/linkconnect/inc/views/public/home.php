...
$hero_img = lc_builder_asset_url('hero_dashboard_mockup.webp');
...
<section class="lc-hero">
  <div class="lc-hero__inner">
    ...
    <div class="lc-hero__visual">
      <img src="<?php echo lc_h($hero_img); ?>" alt="LinkConnect 대시보드 미리보기" width="1024" height="764" decoding="async" fetchpriority="high">
    </div>
  </div>
</section>
